                                    ...
                                    <li class="notification-message">
                                        <a href="#">
                                            <div class="media">
                                                ...
                                                <div class="media-body">
                                                    <p class="noti-details"><span class="noti-title">Megan Bird</span> has booked her appointment to <span class="noti-title">Dr. Ruby Perrin</span></p>
                                    ...
                                    <li class="notification-message">
                                        <a href="#">
                                            <div class="media">
                                                ...
                                                <div class="media-body">
                                                <p class="noti-details"><span class="noti-title">Alvin Boykin</span> sent a amount of $210 for his <span class="noti-title">appointment</span></p>
                                    ...
                                    <li class="notification-message">
                                        <a href="#">
                                            <div class="media">
                                                ...
                                                <div class="media-body">
                                                    <p class="noti-details"><span class="noti-title">Nicholas Hicks</span> send a message <span class="noti-title"> to his doctor</span></p>
                ...
                <div class="sidebar-inner slimscroll">
                    <div id="sidebar-menu" class="sidebar-menu">
                        <ul>
                            ...
                            <li class="{{ 'admin/speciality' == request()->path() ? 'active':''}}">
