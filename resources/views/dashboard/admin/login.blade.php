					...
					<div class="navbar-header">
						...
						<a href="{{route('admin.login')}}" class="navbar-brand logo">
							@foreach ($guestdatas as $item)
								...
								@endphp
								<img src="\admin\assets\img\{{$logoimagepath == NULL ? 'dummy-company-logo.jpg': $logoimagepath}}"
								class="img-fluid" alt="{{$item['appname']}}">
							@endforeach
						</a>
					</div>
									...
									<div class="col-md-12 col-lg-6 login-right">
										...
										<form action="{{route('admin.check')}}" method="post" autocomplete="off">
                                            ...
                                            <div class="form-group form-focus mb-5">
												<input type="text" name="email" class="form-control floating" value="admin@admin.com">
							...
							<div class="col-lg-3 col-md-6">
								...
								<div class="footer-widget footer-about">
									<div class="footer-logo">
										...
										<h2 class="text-white">{{$item['appname']}}</h2>
										@endforeach
									</div>
							...
							<div class="row">
								<div class="col-md-6 col-lg-6">
									<div class="copyright-text">
										<p class="mb-0">&copy; 2021 Doctor Appointment. All rights reserved.</p>
									</div>
								</div>
								<div class="col-md-6 col-lg-6">
